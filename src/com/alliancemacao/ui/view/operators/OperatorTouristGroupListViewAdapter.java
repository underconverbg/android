...
public class OperatorTouristGroupListViewAdapter extends BaseAdapter
{
	  private Context context;                        //运行上下文   
	    ...
	    public OperatorTouristGroupListViewAdapter(Context context, List<Map<String, Object>> listItems)
	    {   
